...
vim.keymap.set("n", "<Space>:", ":Commands<cr>") -- TODO
vim.keymap.set("n", "<Space>h", ":History:<cr>")
vim.keymap.set("n", "<Space>", ":BLines!<cr>")
...
vim.keymap.set("n", "<Space>h", ":History<cr>")   --	v:oldfiles and open buffers
...
vim.keymap.set("n", "<Space>w", ":Jumps<cr>")     --	Jumps
